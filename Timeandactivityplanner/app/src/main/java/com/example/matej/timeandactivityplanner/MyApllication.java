...
/**
 * Created by ESTATE on 25.5.2016.
 */
public class MyApllication extends Application{
    ...
    public void printHashKey(){
        try{
            PackageInfo info =  getPackageManager().getPackageInfo("com.example.matej.timeandactivityplanner", PackageManager.GET_SIGNATURES);
